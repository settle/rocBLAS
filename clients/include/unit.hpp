...
#define ASSERT_BFLOAT8_EQ(a, b) ASSERT_FLOAT_EQ(static_cast<float>(a), static_cast<float>(b))
...
inline void unit_check_general(
    rocblas_int M, rocblas_int N, rocblas_int lda, rocblas_bfloat8* hCPU, rocblas_bfloat8* hGPU)
{
    UNIT_CHECK(M, N, 1, lda, 0, hCPU, hGPU, ASSERT_BFLOAT8_EQ);
}
...
inline void unit_check_general(rocblas_int      M,
                               ...
                               rocblas_int      lda,
                               rocblas_int      strideA,
                               rocblas_bfloat8* hCPU,
                               rocblas_bfloat8* hGPU)
{
    UNIT_CHECK(M, N, batch_count, lda, strideA, hCPU, hGPU, ASSERT_BFLOAT8_EQ);
}
